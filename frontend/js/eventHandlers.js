import { getArticles, createArticle, updateArticle, deleteArticle, importArticles } from './service/articleService.js'
...
const addArticle = article => {
    ...
    deleteButton.onclick = () => deleteArticle(article.id).then(_response => window.location.reload())
...
const importArticlesHandler = (formId) => {
    ...
    importArticles(new FormData(importArticlesForm))
...
const updateArticleHandler = (articleId, form) => {
    ...
    updateArticle(articleId, Object.fromEntries(formData))
...
export { redirectClickHandler, importArticlesHandler, createArticleHandler, addArticle }