...
const importArticles = async (importFile) => fetch('article/import', { method: 'POST', body: importFile })

const deleteArticle = async (id) => await fetch(`${config.apiUrl}/article/${id}`, { method: 'DELETE' })

export { getArticles, getArticle, createArticle, updateArticle, deleteArticle, importArticles }